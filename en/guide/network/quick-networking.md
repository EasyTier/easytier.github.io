...
./easytier-core -d --network-name abc --network-secret abc -p tcp://<Shared Node IP or Domain>:1010
```

```powershell [Windows]
# Run with administrator privileges
.\easytier-core.exe -d --network-name abc --network-secret abc -p tcp://<Shared Node IP or Domain>:1010
```
...
```sh
# Run with administrator privileges
./easytier-core --network-name net1 -p tcp://<Shared Node IP or Domain>:1010 -l 11010
./easytier-core --network-name net2 -p tcp://<Shared Node IP or Domain>:1010 -l 21010
```
